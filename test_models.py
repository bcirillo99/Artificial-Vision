...
#training
n_epoch = 50
model_path="model_resnet_class_w"
log_path="logs_resnet_class_w"
...
model.compile(
    loss=aar_class,      
    optimizer=SGD(0.005),
    metrics=[aar_metric_class,mmae_class,sigma_class,mae_class])

print("Output mediati: ")
score = model.evaluate(val_generator, verbose=False)
print('Val loss:', score[0])
print('Val aar:', score[1])
print('Val mmae:', score[2])
print('Val sigma:', score[3])
print('Val mae:', score[4])
